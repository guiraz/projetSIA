...
// The size of the texture (this would be a useful input)
vec2 vChannelDimensions = vec2(256.0, 256.0);
...
void main(void)
{
        ...
        materialSample = SampleMaterial( vUV, iChannel0, vChannelDimensions, fNormalScale );
